...
async def run() -> None:
    ...
    async with CMOPClient(settings) as client:
        ...
        # Build agent with unified session
        ...
        # Interactive mode (same session — agent remembers everything)
